...
export default function Welcome({ auth, laravelVersion, phpVersion, categories = [], featuredServices = [] }) {
    return (
        <>
                ...
                <div className="relative z-10">
                    ...
                    <header className="container mx-auto px-6 py-6 flex justify-between items-center">
                        <div className="flex items-center gap-2">
                            ...
                            <span className="text-xl font-bold tracking-tight text-slate-900">WorkYarder <span className="text-green-600 text-sm align-top">UK</span></span>
                        </div>
                        ...
                        <div className="flex items-center gap-4">
                            {auth.user ? (
                                ...
                                <>
                                    ...
                                    <Link
                                        href={route('register')}
                                        className="rounded-full bg-green-600 px-5 py-2.5 text-sm font-medium text-white shadow-lg shadow-green-500/30 transition hover:bg-green-700 hover:shadow-green-500/50"
                                    >
                                        Register
                                    </Link>
                                </>
                    ...
                    <section className="container mx-auto px-6 pt-20 pb-32 text-center max-w-4xl">
                        <h1 className="text-5xl md:text-7xl font-extrabold tracking-tight text-slate-900 mb-6 leading-tight">
                            <span className="text-transparent bg-clip-text bg-gradient-to-r from-emerald-600 to-green-600">Work Smarter,</span><br/>
                        ...
                        <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                            <Link href={route('register')} className="w-full sm:w-auto rounded-full bg-green-600 px-8 py-4 text-base font-bold text-white shadow-xl shadow-green-500/30 transition hover:bg-green-700 hover:-translate-y-1">
                                Get Started Free
                            </Link>
                            <Link href={route('services.index')} className="w-full sm:w-auto rounded-full bg-white px-8 py-4 text-base font-bold text-slate-800 shadow-xl shadow-slate-200 transition hover:bg-slate-50 hover:-translate-y-1 flex items-center justify-center gap-2">
                    ...
                    <section id="features" className="bg-slate-100 py-24 relative z-20 shadow-inner">
                        <div className="container mx-auto px-6">
                            <div className="text-center mb-16">
                                <span className="text-green-600 font-bold tracking-wider text-sm uppercase bg-green-100 px-3 py-1 rounded-full">Our Services</span>
                            ...
                            <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
                                {categories.slice(0, 6).map((category, idx) => (
                                    <Link href={route('services.index', { category: category.slug })} key={category.id} className={`bg-white rounded-3xl p-8 shadow-xl shadow-slate-200/50 hover:shadow-2xl hover:shadow-green-500/10 transition-all border border-slate-100 group relative ${idx === 1 ? 'transform md:-translate-y-4' : ''}`}>
                                        {idx === 1 && <div className="absolute inset-0 bg-gradient-to-b from-green-50 to-transparent opacity-50 rounded-3xl pointer-events-none"></div>}
                                        <div className={`w-14 h-14 rounded-2xl flex items-center justify-center mb-6 transition-transform relative z-10 ${idx % 3 === 0 ? 'bg-emerald-50 text-emerald-600 group-hover:scale-110' : idx % 3 === 1 ? 'bg-green-100 text-green-600 group-hover:scale-110' : 'bg-teal-50 text-teal-600 group-hover:scale-110'}`}>
                                            <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 3v4M3 5h4M6 17v4m-2-2h4m5-16l2.286 6.857L21 12l-5.714 2.143L13 21l-2.286-6.857L5 12l5.714-2.143L13 3z" />
                                            </svg>
                                        </div>
                                        <h3 className="text-xl font-bold text-slate-900 mb-3 relative z-10">{category.name}</h3>
                                        <p className="text-slate-500 mb-6 text-sm relative z-10 line-clamp-3">{category.description}</p>
                                        <div className="pt-4 border-t border-slate-100 flex justify-between items-center relative z-10">
                                            <span className="text-slate-500 text-sm">Explore Services</span>
                                            <svg xmlns="http://www.w3.org/2000/svg" className={`h-5 w-5 ${idx % 3 === 0 ? 'text-emerald-600' : idx % 3 === 1 ? 'text-green-600' : 'text-teal-600'}`} fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <section id="how-it-works" className="py-24 bg-white relative">
                        <div className="container mx-auto px-6">
                            <div className="text-center mb-16">
                                <span className="text-lime-600 font-bold tracking-wider text-sm uppercase bg-lime-100 px-3 py-1 rounded-full">How it works</span>
                            ...
                            <div className="flex flex-col md:flex-row items-center justify-center gap-8 md:gap-12 max-w-4xl mx-auto">
                                <div className="text-center flex-1">
                                    <div className="w-20 h-20 bg-green-600 text-white rounded-full flex items-center justify-center text-3xl font-bold mx-auto mb-6 shadow-lg shadow-green-500/40 border-4 border-green-200">1</div>
                                ...
                                <div className="text-center flex-1">
                                    <div className="w-20 h-20 bg-green-600 text-white rounded-full flex items-center justify-center text-3xl font-bold mx-auto mb-6 shadow-lg shadow-green-500/40 border-4 border-green-200">2</div>
                                ...
                                <div className="hidden md:block w-16 h-1 bg-slate-200 rounded"></div>
                                <div className="text-center flex-1">
                                    <div className="w-20 h-20 bg-green-600 text-white rounded-full flex items-center justify-center text-3xl font-bold mx-auto mb-6 shadow-lg shadow-green-500/40 border-4 border-green-200">3</div>
                            ...
                            <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
                                ...
                                <div className="bg-white p-8 rounded-3xl shadow-lg border border-slate-100">
                                    ...
                                    <div className="flex items-center gap-3 border-t border-slate-100 pt-4">
                                        <div className="w-10 h-10 rounded-full bg-emerald-100 text-emerald-600 flex items-center justify-center font-bold">SJ</div>
                                        <div>
                                ...
                                <div className="bg-white p-8 rounded-3xl shadow-lg border border-slate-100">
                                    ...
                                    <div className="flex items-center gap-3 border-t border-slate-100 pt-4">
                                        <div className="w-10 h-10 rounded-full bg-teal-100 text-teal-600 flex items-center justify-center font-bold">ER</div>
                                        <div>
                    ...
                    <section className="py-24 relative overflow-hidden">
                        <div className="absolute inset-0 bg-gradient-to-br from-emerald-600 via-green-600 to-lime-500"></div>
                        
                        <div className="container mx-auto px-6 relative z-10">
                            <div className="max-w-4xl mx-auto bg-white rounded-[2rem] p-8 md:p-12 shadow-2xl">
                                <div className="text-center mb-10">
                                    <h2 className="text-3xl md:text-4xl font-extrabold text-emerald-600 mb-4">Book Your Service Now</h2>
                                ...
                                <div className="flex justify-between items-center mb-10 max-w-2xl mx-auto relative px-4">
                                    ...
                                    <div className="flex flex-col items-center gap-2 bg-white px-2">
                                        <div className="w-8 h-8 rounded-full bg-emerald-600 text-white flex items-center justify-center text-sm font-bold ring-4 ring-emerald-50">1</div>
                                        <span className="text-xs font-bold text-emerald-600">Address</span>
                                    </div>
                                    <div className="flex flex-col items-center gap-2 bg-white px-2">
                                ...
                                <div className="text-center mb-6">
                                    <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8 text-emerald-600 mx-auto mb-2" viewBox="0 0 20 20" fill="currentColor">
                                ...
                                <form className="max-w-xl mx-auto space-y-4" onSubmit={(e) => { e.preventDefault(); window.location.href = route('services.index'); }}>
                                    <input type="text" placeholder="Search for a service... (e.g. plumbing, garden)" className="w-full px-4 py-3 rounded-lg border border-slate-200 focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-transparent transition" />
                                    <div className="grid grid-cols-3 gap-4">
                                        <input type="text" placeholder="City" className="w-full px-4 py-3 rounded-lg border border-slate-200 focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-transparent transition" />
                                        <input type="text" placeholder="County" className="w-full px-4 py-3 rounded-lg border border-slate-200 focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-transparent transition" />
                                        <input type="text" placeholder="Postcode" className="w-full px-4 py-3 rounded-lg border border-slate-200 focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-transparent transition" />
                                    </div>
                                    <button type="submit" className="w-full bg-emerald-600 text-white font-bold py-4 rounded-lg hover:bg-emerald-700 transition shadow-lg shadow-emerald-500/30">
                                        Search Providers
                                    </button>
                                </form>
                            </div>
                        ...
                        <div className="container mx-auto px-6 grid grid-cols-2 md:grid-cols-4 gap-8 mb-8">
                            ...
                            <div>
                                ...
                                <ul className="space-y-2 text-sm">
                                    <li><a href="#" className="hover:text-green-400 transition">Housekeeping</a></li>
                                    <li><a href="#" className="hover:text-green-400 transition">Garden Care</a></li>
                                    <li><a href="#" className="hover:text-green-400 transition">Maintenance</a></li>
                                </ul>
                            </div>
